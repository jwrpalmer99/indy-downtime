...
Indy Downtime Tracker is a Foundry VTT v13 module for any system (best integration with 5e/pf2e) that models (downtime) projects with flexible multi-phase progress trackers and plans. Each tracker gets its own character sheet tab (shared amongst players) with progress, check selection, and roll controls.
